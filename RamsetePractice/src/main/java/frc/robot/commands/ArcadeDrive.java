...
public class ArcadeDrive extends CommandBase {
     ...
     * @param initBrake    whether or not to start and end the command in brake or
     *                     coast mode
     */
    public ArcadeDrive(Supplier<Double> forwardVal, Supplier<Double> rotateVal, boolean squareInputs,
        ...
        // Requires must be included to use this command as a default command for the
        // drive base
    ...
    public void execute() {
        ...
        this.driveSubsystem.arcadeDrive(forwardVal.get(), rotateVal.get(), squareInputs);
